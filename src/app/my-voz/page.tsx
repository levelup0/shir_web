...
export default function Page() {
    ...
    const changeStatus = async (id: any, status: any) => {
        ...
        form.append('voz_id', id);
        form.append('status', status);

        const response = await requestPostWithToken(VOZ_UPDATE_STATUS, form);
        if (response?.success == true) {
                                                    ...
                                                    {item?.sector}
                                                            ...
                                                            <td className="border-b border-[#eee]  dark:border-strokedark p-[5px]">
                                                                <div className="flex gap-[5px]">
                                                                    ...
                                                                    'created' ? (
                                                                        <button
                                                                            className="bg-orange-600 group relative text-white rounded-[5px] px-[10px] py-[8px] hover:bg-blue-700 "
                                                                            onClick={() =>
                                                                                changeStatus(
                                                                                    item?.id,
                                                                                    'closed',
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <span className="hidden group-hover:flex text-[14px] absolute top-[-38px] rounded-[4px] px-[10px] bg-blue-300">
                                                                                Закрыть
                                                                                вызов
                                                                            </span>
                                                                        </button>
